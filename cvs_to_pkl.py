...
class MotionPlayer:
    def __init__(self, args):
        ...
        if self.args.robot_type == 'g1':
            ...
            self.robot = pin.RobotWrapper.BuildFromURDF('robot_description/g1/g1_29dof_rev_1_0.urdf',
                                                        'robot_description/g1', pin.JointModelFreeFlyer())
    ...
    def run_viewer(self):
        ...
        while not self.gym.query_viewer_has_closed(self.viewer):
            for frame_nr in range(0, max_motion_length):
    ...
    def convert_only(self):
        ...
        save_path = f"pkl_data/{self.args.robot_type}/{file_base}.pkl"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--no_viewer', action='store_true', help="Only convert, no rendering", default='True')
